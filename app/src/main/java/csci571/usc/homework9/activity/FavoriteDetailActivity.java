...
/**
 * Created by xuchen on 2017/4/22.
 */
        ...
        public void handleMessage(Message msg) {
            ...
            DetailviewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
                ...
                public void onPageSelected(int position) {
                    Toast.makeText(FavoriteDetailActivity.this,"you select"+position,Toast.LENGTH_SHORT).show();
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        dialog.registerCallback(callbackManager, new FacebookCallback<Sharer.Result>() {
            ...
            public void onSuccess(Sharer.Result result) {
                Toast.makeText(FavoriteDetailActivity.this,"post success",Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onCancel() {
                Toast.makeText(FavoriteDetailActivity.this,"post canceled",Toast.LENGTH_SHORT).show();
