...
public class PageFrag extends Fragment {
    ...
    public Handler PageFragHandler=new Handler(){
        @Override
    ...
    public class PageFragDownLoadThread extends Thread{
        String searchContent;
        String type;
        public PageFragDownLoadThread(String content,String type)
        {
        ...
        public void run()
        {
            ...
            if(type=="normal")
            {
                result_str= Util.getJsonFromPHP(searchContent,"page");
            ...
            ds.closeDB();
            PageFragHandler.sendEmptyMessage(0x111);
        }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState)
    {
        ...
        nextbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new PageFragDownLoadThread(ResultActivity.searchContent,"nextpage").start();
            }
        });
        ...
        previousbutton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                new PageFragDownLoadThread(ResultActivity.searchContent,"previouspage").start();
            }
        });
        ...
        //找到Listview
        pageList=(ListView)view.findViewById(R.id.userlistview);



        adapter=new ListAdapter(getActivity(),data,"page");
        pageList.setAdapter(adapter);

        new PageFragDownLoadThread(ResultActivity.searchContent,"normal").start();
        return view;
    }
}
