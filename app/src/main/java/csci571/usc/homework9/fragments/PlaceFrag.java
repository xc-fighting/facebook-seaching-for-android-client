...
public class PlaceFrag extends Fragment {
    ...
    public Handler PlaceFragHandler=new Handler(){
        @Override
    ...
    public class PlaceFragDownLoadThread extends Thread{
        String searchContent;
        String type;
        public PlaceFragDownLoadThread(String content,String type)
        {
        ...
        public void run()
        {
            ...
            if(type=="normal")
            {
                result_str= Util.getJsonFromPHP(searchContent,"place");
            ...
            ds.closeDB();
            PlaceFragHandler.sendEmptyMessage(0x111);
        }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState)
    {
        ...
        nextbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new PlaceFragDownLoadThread(ResultActivity.searchContent,"nextpage").start();
            }
        });
        ...
        previousbutton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                new PlaceFragDownLoadThread(ResultActivity.searchContent,"previouspage").start();
            }
        });
        ...
        //找到Listview
        placeList=(ListView)view.findViewById(R.id.userlistview);



        adapter=new ListAdapter(getActivity(),data,"place");
        placeList.setAdapter(adapter);

        new PlaceFragDownLoadThread(ResultActivity.searchContent,"normal").start();
        return view;
    }
}
