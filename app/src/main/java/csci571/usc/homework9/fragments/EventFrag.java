...
public class EventFrag extends Fragment {
    ...
    public Handler EventFragHandler=new Handler(){
        @Override
    ...
    public class EventFragDownLoadThread extends Thread{
        String searchContent;
        String type;
        public EventFragDownLoadThread(String content,String type)
        {
        ...
        public void run()
        {
            ...
            if(type=="normal")
            {
                result_str= Util.getJsonFromPHP(searchContent,"event");
            ...
            ds.closeDB();
            EventFragHandler.sendEmptyMessage(0x111);
        }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState)
    {
        ...
        nextbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new EventFragDownLoadThread(ResultActivity.searchContent,"nextpage").start();
            }
        });
        ...
        previousbutton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                new EventFragDownLoadThread(ResultActivity.searchContent,"previouspage").start();
            }
        });
        ...
        //找到Listview
        eventList=(ListView)view.findViewById(R.id.userlistview);



        adapter=new ListAdapter(getActivity(),data,"event");
        eventList.setAdapter(adapter);

        new EventFragDownLoadThread(ResultActivity.searchContent,"normal").start();
        return view;
    }
